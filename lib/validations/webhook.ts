 ...
 * Matches behaviour of MartinClare/edge + cloud middleware variance.
 */
...
/**
 * MartinClare/edge `main` sends JSON only (`_send_to_central_server`): nested `analysis` each cycle.
